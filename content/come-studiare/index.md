...
| System | My Technique |
|--------|-------------|
| Working Memory | Micro-chunks (2 min), talk aloud |
| Short-Term | 3-Pass System |
| Long-Term | Spaced recall schedule |
| Semantic | Mind maps, why chains, this note graph |
| Episodic | Physical anchors, location rotation |
| Procedural | Type code, execute by hand |
| Implicit | Interleaving problems |
| Prospective | Trigger-action pairs for exams |

## Bad Brain Days

- **Green:** Full 5-step method
- **Yellow:** Voice only, review old notes
- **Red:** Passive AI voice, zero guilt
